...
"#ifdef _MSC_VER	",
"#pragma warning(push)",
"#pragma warning(disable : 4065 4100 4244 4189 4101 4127 4102)",
"#endif",
"#define FLEX_SCANNER",
...
"%+",
"%c",
"yyFlexLexer::yyFlexLexer( io::stream* arg_yyin, io::stream* arg_yyout )",
"	{",
"	yyin = arg_yyin;",
"	yyout = arg_yyout;",
"	yy_c_buf_p = 0;",
...
"	}",
"",
"void yyFlexLexer::switch_streams( io::stream* new_in, io::stream* new_out )",
"	{",
"	if ( new_in )",
"		{",
"		yy_delete_buffer( yy_current_buffer  YY_CALL_LAST_ARG);",
...
"		return 0;",
"",
"	int bytes_read = yyin->read( buf, max_size );",
"",
"	if ( yyin->fail() )",
"		return -1;",
"	else",
...
"%*",
"	{",
"	char *dest = YY_G(yy_current_buffer)->yy_ch_buf;",
...
"YY_DECL_LAST_ARG",
"%+",
"void yyFlexLexer::yyunput( int c, char* yy_bp YY_DEF_LAST_ARG)",
"%*",
"	{",
...
"YY_DECL_LAST_ARG",
"%+",
"void yyFlexLexer::yyrestart( io::stream* input_file )",
"%*",
"	{",
"	if ( ! YY_G(yy_current_buffer) )",
"		YY_G(yy_current_buffer) =",
...
"YY_DECL_LAST_ARG",
"%+",
"YY_BUFFER_STATE yyFlexLexer::yy_create_buffer( io::stream* file, int size )",
"%*",
"	{",
"	YY_BUFFER_STATE b;",
"",
...
"extern \"C\" int isatty YY_PARAMS(( int ));",
"#endif",
"void yyFlexLexer::yy_init_buffer( YY_BUFFER_STATE b, io::stream* file )",
"%*",
"",
"	{",
"	int oerrno = errno;",
...
"void *yyalloc (yy_size_t size YY_DECL_LAST_ARG)",
"	{",
"	return (void *) tycho::core::malloc( size );",
"	}",
"#endif",
"",
...
"void *yyrealloc ( void *ptr, yy_size_t size YY_DECL_LAST_ARG)",
"	{",
...
"	 */",
"	return (void *) tycho::core::realloc( (char *) ptr, size );",
"	}",
"#endif",
"",
...
"void yyfree ( void *ptr YY_DECL_LAST_ARG)",
"	{",
"	tycho::core::free( (char *) ptr );	/* see yyrealloc() for (char *) cast */",
"	}",
"#endif",
"",
"#if YY_MAIN",
